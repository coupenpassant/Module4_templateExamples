...
\footnotetext{\textbf{Abbreviations:} ANA, anti-nuclear antibodies; APC,
antigen-presenting cells; IRF, interferon regulatory factor..}
...
\begin{figure}
\centering
\includegraphics{StatsMedExample_files/figure-latex/plot-ref-1.pdf}
